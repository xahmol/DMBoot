...
- **Phase 2: in progress.**
  ...
  - Splash screen (2026-09-26): overlay 6 (F2, then information), from `assets/splash.petmate`. Verified in 40 and 80 columns on .23 and .237. VDC colour 12 is brown on the Commodore monitor (brown fix) but olive on a TV/converter without it; accepted as is.
